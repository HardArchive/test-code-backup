...
/* Object interface: ICCopyPathEx, ver. 0.0,
   GUID={0xB7C740E6,0x3009,0x4A2A,{0x83,0x5B,0x6C,0x81,0x87,0x99,0xC0,0xBD}} */
...
const CInterfaceProxyVtbl * _CopyPath_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICCopyPathExProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CopyPath_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICCopyPathExStubVtbl,
    0
};

PCInterfaceName const _CopyPath_InterfaceNamesList[] = 
{
    "ICCopyPathEx",
    0
};

const IID *  _CopyPath_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CopyPath_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CopyPath, pIID, n)

int __stdcall _CopyPath_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CopyPath_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CopyPath_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CopyPath_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CopyPath_StubVtblList,
    (const PCInterfaceName * ) & _CopyPath_InterfaceNamesList,
    (const IID ** ) & _CopyPath_BaseIIDList,
    & _CopyPath_IID_Lookup, 
    1,
    2,
