...
/* Object interface: ICCopyPathEx, ver. 0.0,
   GUID={0xD1AB33F0,0xA2C7,0x4102,{0xB3,0x54,0x9B,0xA0,0x97,0x8C,0x9C,0x2B}} */
...
const CInterfaceProxyVtbl * _TestMenu2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICCopyPathExProxyVtbl,
    0
};

const CInterfaceStubVtbl * _TestMenu2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICCopyPathExStubVtbl,
    0
};

PCInterfaceName const _TestMenu2_InterfaceNamesList[] = 
{
    "ICCopyPathEx",
    0
};

const IID *  _TestMenu2_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _TestMenu2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TestMenu2, pIID, n)

int __stdcall _TestMenu2_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_TestMenu2_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo TestMenu2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TestMenu2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TestMenu2_StubVtblList,
    (const PCInterfaceName * ) & _TestMenu2_InterfaceNamesList,
    (const IID ** ) & _TestMenu2_BaseIIDList,
    & _TestMenu2_IID_Lookup, 
    1,
    2,
