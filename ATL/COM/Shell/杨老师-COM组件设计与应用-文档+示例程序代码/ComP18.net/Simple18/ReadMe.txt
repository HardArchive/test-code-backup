...
应用程序向导为您创建了这个 Simple18 项目，供您用作
编写动态链接库(DLL)的起点。
...
Simple18.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(Simple18.h)
        GUID 定义(Simple18_i.c)
        类型库(Simple18.tlb)
        封送处理代码(Simple18_p.c and dlldata.c)

Simple18.h
    此文件包含在 Simple18.idl 中定义的项的 C++
...
Simple18ps.vcproj
	...
	dlldata.c、Simple18_i.c 和 Simple18_p.c，这些是
