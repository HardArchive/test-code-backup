...
Simple4.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(Simple4.h)
        GUID 定义(Simple4_i.c)
        类型库(Simple4.tlb)
        封送处理代码(Simple4_p.c and dlldata.c)

Simple4.h
    此文件包含在 Simple4.idl 中定义的项的 C++
...
Simple4ps.vcproj
	...
	dlldata.c、Simple4_i.c 和 Simple4_p.c，这些是
