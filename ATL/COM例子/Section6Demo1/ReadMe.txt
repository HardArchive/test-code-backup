========================================================================
    活动模板库：Section6Demo1 项目概述
========================================================================

应用程序向导已为您创建了此 Section6Demo1 项目，您可以在此基础之上
编写自己的动态链接库 (DLL)。
...
Section6Demo1.idl
    ...
    和 coclass 的 IDL 定义。
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明                 (Section6Demo1.h)
        GUID 定义                                (Section6Demo1_i.c)
        一个类型库                               (Section6Demo1.tlb)
        封送代码                                 (Section6Demo1_p.c 和 dlldata.c)

Section6Demo1.h
    此文件包含在 Section6Demo1.idl 中定义的项的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 Section6Demo1.pch 的预编译头 (PCH) 文件
...
Section6Demo1ps.vcproj
	...
	dlldata.c、Section6Demo1_i.c 和 Section6Demo1_p.c，它们。
