...
// Modified by Jeff Xi,Date: 2001-5-30  15:15:58
//Notes: user defined service control code
#define SERVICE_CONTROL_UPDATE    129
////////////////////////////////////////////////
...
class CNTService {
	...
	protected:	// data members
		...
		char			m_cChildSeqNo;			// 子进程序号，从'0'-'9'之间
	...
	public:		// overridables
		...
		// Modified by Jeff Xi,Date: 2001-5-30  15:11:48
		//Notes:process user defined service control code
