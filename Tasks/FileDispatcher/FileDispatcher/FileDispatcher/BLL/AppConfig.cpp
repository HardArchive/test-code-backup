...
#pragma region 相关的目录配置
	...
	// 监控目录、拷贝文件夹目标目录、拷贝文件目标目录
	GetRegPath(hKey, "WatchDirPath", this->m_szWatchDirPath, "d:\\testout\\Other\\");
	GetRegPath(hKey, "DestDirPath", this->m_szDestDirPath, "d:\\testout\\Other\\");
	GetRegPath(hKey, "DestFilePath", this->m_szDestFilePath, "d:\\testout\\Other\\");
#pragma endregion
