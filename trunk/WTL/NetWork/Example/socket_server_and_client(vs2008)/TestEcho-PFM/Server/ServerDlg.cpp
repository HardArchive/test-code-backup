...
void CServerDlg::OnBnClickedStart()
{
	...
	//m_Server.SetFreeSocketObjPool(2000);
	//m_Server.SetFreeSocketObjHold(4000);
	//m_Server.SetFreeBufferObjPool(4000);
	//m_Server.SetFreeBufferObjHold(8000);
	//m_Server.SetAcceptSocketCount(100);
