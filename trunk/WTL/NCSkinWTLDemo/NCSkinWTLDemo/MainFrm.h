...
public:
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_RANGE_HANDLER(10,13,OnTitleButtonHandle)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnTitleButtonHandle(WPARAM wParam,LPARAM lParam,HWND hWndCtl, BOOL& bHandled)
	{
		switch(lParam)
		{
		case 10:
