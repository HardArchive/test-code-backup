...
typedef enum _VI_STR {
	VI_STR_COMMENTS			= 0,	// Comments备注
	VI_STR_COMPANYNAME		= 1,	// CompanyName公司名
	VI_STR_FILEDESCRIPTION	= 2,	// FileDescription文件描述
	VI_STR_FILEVERSION		= 3,	// FileVersion文件版本
	VI_STR_INTERNALNAME		= 4,	// InternalName内部名称
	VI_STR_LEGALCOPYRIGHT	= 5,	// LegalCopyright版权
	VI_STR_LEGALTRADEMARKS	= 6,	// LegalTrademarks合法商标
	VI_STR_ORIGINALFILENAME	= 7,	// OriginalFilename源文件名
	VI_STR_PRIVATEBUILD		= 8,	// PrivateBuild
	VI_STR_PRODUCTNAME		= 9,	// ProductName产品名称
	VI_STR_PRODUCTVERSION	= 10,	// ProductVersion产品版本
