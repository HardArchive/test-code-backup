...
BANKREGULARRATES g_szBankRegularRates[6] = {
	...
	{_T("中信银行"), {{{0,1},0.39},{{1,3},2.86},{{1,6},3.08},{{0,1},3.30},{{0,2},4.125},{{0,3},4.675},{{0,5},5.225}}},
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	STORAGETIME stuInStorageTime = {0, 1};
	...
	STORAGETIME stuInIntervalTime = {1, 1};
	PREGULARRATES pstuRegularates7 = &g_szBankRegularRates[5].stuRegularRates[6];
	double dPrincipalInterest7 = clsRateCalc.GetRegular(1000, pstuRegularates7, stuInIntervalTime, stuInStorageTime);
