========================================================================
    活动模板库：Section8Demo2 项目概述
========================================================================

应用程序向导已为您创建了此 Section8Demo2 项目，您可以在此基础之上
编写自己的动态链接库 (DLL)。
...
Section8Demo2.idl
    ...
    和 coclass 的 IDL 定义。
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明                 (Section8Demo2.h)
        GUID 定义                                (Section8Demo2_i.c)
        一个类型库                               (Section8Demo2.tlb)
        封送代码                                 (Section8Demo2_p.c 和 dlldata.c)

Section8Demo2.h
    此文件包含在 Section8Demo2.idl 中定义的项的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 Section8Demo2.pch 的预编译头 (PCH) 文件
...
Section8Demo2ps.vcproj
	...
	dlldata.c、Section8Demo2_i.c 和 Section8Demo2_p.c，它们。
