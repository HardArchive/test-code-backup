...
Simple2.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(Simple2.h)
        GUID 定义(Simple2_i.c)
        类型库(Simple2.tlb)
        封送处理代码(Simple2_p.c and dlldata.c)

Simple2.h
    此文件包含在 Simple2.idl 中定义的项的 C++
...
Simple2ps.vcproj
	...
	dlldata.c、Simple2_i.c 和 Simple2_p.c，这些是
