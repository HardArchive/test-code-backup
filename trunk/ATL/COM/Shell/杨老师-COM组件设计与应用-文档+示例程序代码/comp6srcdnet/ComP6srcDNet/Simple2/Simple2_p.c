...
/* Object interface: IFun, ver. 0.0,
   GUID={0x9C0330E2,0xD53F,0x43E3,{0xB8,0x99,0x97,0xB9,0x4B,0xF7,0x6B,0x64}} */
...
CINTERFACE_PROXY_VTABLE(5) _IFunProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IFun::Add */ ,
    (void *) (INT_PTR) -1 /* IFun::Cat */
};
...
const CInterfaceProxyVtbl * _Simple2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFunProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Simple2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFunStubVtbl,
    0
};

PCInterfaceName const _Simple2_InterfaceNamesList[] = 
{
    "IFun",
    0
};
...
#define _Simple2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Simple2, pIID, n)

int __stdcall _Simple2_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Simple2_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Simple2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Simple2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Simple2_StubVtblList,
    (const PCInterfaceName * ) & _Simple2_InterfaceNamesList,
    0, // no delegation
    & _Simple2_IID_Lookup, 
    1,
    2,
