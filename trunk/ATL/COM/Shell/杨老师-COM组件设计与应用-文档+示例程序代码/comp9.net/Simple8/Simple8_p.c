...
extern const MIDL_SERVER_INFO IDispSimple_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IDispSimple_ProxyInfo;
...
/* 1060 */	NdrFcShort( 0xfd12 ),	/* Offset= -750 (310) */
/* 1062 */	
			0x11, 0x4,	/* FC_RP [alloced_on_stack] */
/* 1064 */	NdrFcShort( 0x6 ),	/* Offset= 6 (1070) */
/* 1066 */	
			0x13, 0x0,	/* FC_OP */
/* 1068 */	NdrFcShort( 0xfd1a ),	/* Offset= -742 (326) */
...
/* Object interface: IDispSimple, ver. 0.0,
   GUID={0xD432BA0B,0x920F,0x4C92,{0xBE,0x2D,0xA4,0xB5,0x69,0xF7,0xF2,0x1B}} */

#pragma code_seg(".orpc")
static const unsigned short IDispSimple_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IDispSimple_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IDispSimple_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDispSimple_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IDispSimpleProxyVtbl = 
{
    &IDispSimple_ProxyInfo,
    &IID_IDispSimple,
    ...
    (void *) (INT_PTR) -1 /* IDispSimple::Add */ ,
    (void *) (INT_PTR) -1 /* IDispSimple::Upper */
};


static const PRPC_STUB_FUNCTION IDispSimple_table[] =
{
...
CInterfaceStubVtbl _IDispSimpleStubVtbl =
{
    &IID_IDispSimple,
    &IDispSimple_ServerInfo,
    9,
    &IDispSimple_table[-3],
...
const CInterfaceProxyVtbl * _Simple8_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IDispSimpleProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Simple8_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IDispSimpleStubVtbl,
    0
};

PCInterfaceName const _Simple8_InterfaceNamesList[] = 
{
    "IDispSimple",
    0
};

const IID *  _Simple8_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _Simple8_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Simple8, pIID, n)

int __stdcall _Simple8_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Simple8_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Simple8_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Simple8_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Simple8_StubVtblList,
    (const PCInterfaceName * ) & _Simple8_InterfaceNamesList,
    (const IID ** ) & _Simple8_BaseIIDList,
    & _Simple8_IID_Lookup, 
    1,
    2,
