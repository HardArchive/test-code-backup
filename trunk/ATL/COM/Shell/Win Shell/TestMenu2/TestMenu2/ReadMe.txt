========================================================================
    活动模板库 : TestMenu2 项目概况
========================================================================

应用程序向导为您创建了这个 TestMenu2 项目，供您用作
编写动态链接库(DLL)的起点。
...
TestMenu2.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(TestMenu2.h)
        GUID 定义(TestMenu2_i.c)
        类型库(TestMenu2.tlb)
        封送处理代码(TestMenu2_p.c and dlldata.c)

TestMenu2.h
    此文件包含在 TestMenu2.idl 中定义的项的 C++
...
TestMenu2ps.vcproj
	...
	dlldata.c、TestMenu2_i.c 和 TestMenu2_p.c，这些是
