========================================================================
    活动模板库 : TestMenu3 项目概况
========================================================================

应用程序向导为您创建了这个 TestMenu3 项目，供您用作
编写动态链接库(DLL)的起点。
...
TestMenu3.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(TestMenu3.h)
        GUID 定义(TestMenu3_i.c)
        类型库(TestMenu3.tlb)
        封送处理代码(TestMenu3_p.c and dlldata.c)

TestMenu3.h
    此文件包含在 TestMenu3.idl 中定义的项的 C++
...
TestMenu3ps.vcproj
	...
	dlldata.c、TestMenu3_i.c 和 TestMenu3_p.c，这些是
