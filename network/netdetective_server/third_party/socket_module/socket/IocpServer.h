...
public:
	...
	{
		m_dwIocpThreadCount	=::GetCpuCount() * 2;
		m_dwAcceptSocketCount = m_dwIocpThreadCount;
...
public:/* ISocketServer 接口方法实现 */
	...
	virtual BOOL			Disconnect		(DWORD dwConnID);             //关闭连接
...
private:
	...
	CCriSec				    m_cslCriSecConnID; //连接网吧ID临界区
