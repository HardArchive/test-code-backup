...
class CmdLine : public CmdLineInterface
{
	protected:
		 ...
		 */
		//*_delimiter 字符是用来分隔参数标志/名称 从价值。默认为“”（空格）。
		char _delimiter;
...
private:
	...
	public:
		 ...
		 * parsed.
		 * \param message - The message to be used in the usage 描述消息
		 * output.
		 * \param version - The version number to be used in the 版本号
		 * --version switch.
		 * \param delimiter - The character that is used to separate 参数分隔符，默认空格
		 * the argument flag/name from the value.  Defaults to ' ' (space).
		 * \param helpAndVersion - Whether or not to create the Help and 是否启用版本号和帮助 默认启用
