// Accelerator2Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "Accelerator2.h"
#include "Accelerator2Dlg.h"
...
void CAccelerator2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CAccelerator2Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CAccelerator2Dlg, CDialog)
	//{{AFX_MSG_MAP(CAccelerator2Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CAccelerator2Dlg message handlers

BOOL CAccelerator2Dlg::OnInitDialog()
{
...
void CAccelerator2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CAccelerator2Dlg::OnQueryDragIcon()
{
