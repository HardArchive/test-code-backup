========================================================================
控制台应用程序：PurenessScopeServer 项目概述
========================================================================
...
PSClient工程编译需要依赖duilib，请去http://www.duilib.com/下载duilib的源代码并编译，把编译后的duilib.lib放在PSClient的lib文件夹下。
并把duilib.dll放在PSClient的bin目录下。
