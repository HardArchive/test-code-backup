...
#ifdef _WIN64
		#ifdef _DEBUG
			#pragma comment(lib, "../../Bin/x64/HPSocket_UD.lib")
		#else
			#pragma comment(lib, "../../Bin/x64/HPSocket_U.lib")
		#endif
	#else
		#ifdef _DEBUG
			#pragma comment(lib, "../../Bin/x86/HPSocket_UD.lib")
		#else
			#pragma comment(lib, "../../Bin/x86/HPSocket_U.lib")
		#endif
#endif
