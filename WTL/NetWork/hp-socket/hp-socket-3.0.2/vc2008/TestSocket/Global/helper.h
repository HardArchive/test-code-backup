...
#include "../../Common/Src/socket/SocketHelper.h"
...
void PostOnError(CONNID dwConnID, EnSocketOperation enOperation, int iErrorCode);
void PostOnAccept(CONNID dwConnID, const CString& strAddress, USHORT usPort, BOOL bPass);
...
void PostOnConnect(CONNID dwConnID, const CString& strAddress, USHORT usPort);
void PostOnShutdown();
