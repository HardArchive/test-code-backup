...
public:
	...
	//{
	//	HWND hWnd = this->Create(hWndParent, rect, szWindowName, dwStyle|LVS_OWNERDRAWFIXED, dwExStyle, MenuOrID, lpCreateParam);
	//	SubclassWindow(hWnd);
	//	return hWnd;
	//}
	...
	BOOL LoadSettings()
	{
		...
		m_rgbHeaderBackground = 0x0005FE1A;
